  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-2/4 h-3/4 bg-ws-950 rounded-2xl">
          <Dialog.Title className="text-3xl text-ws-100 text-left p-5 border-b border-solid border-ws-700">添加订阅</Dialog.Title>
          <Dialog.Description className="text-ws-100 text-center p-5">
            <div>
